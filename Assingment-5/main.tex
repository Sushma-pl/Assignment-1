...
\end{align}
As CLT states that summation of i.i.d rvs from any distribution are normally distributed as sample size increases .
For X 
\begin{align}
    \lambda = n \\
    \pr{X = k} = \frac{n^k e^{-n}}{k!}
\end{align}
Now consider a another random variable, $Z_n$
\begin{align}
    Z_n = \frac{X - n \mu}{\sqrt{n \sigma^2}}
\end{align}
Then \textbf{CLT} states that $Z_n$ converges to standard normal distribution as n goes to infinity i.e
\begin{align}
